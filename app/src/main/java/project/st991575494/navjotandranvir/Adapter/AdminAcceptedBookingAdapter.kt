...
// This class is reponsible to populated accepted bookings recyclerview

class AdminAcceptedBookingAdapter (private val bookingList : ArrayList<Service>) : RecyclerView.Adapter<AdminAcceptedBookingAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {

        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.admin_booking_accepted, parent, false)
